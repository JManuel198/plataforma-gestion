...
`activo`) llevan los dos, y Servicios y EPPs (sin `activo`) solo el lápiz. Está documentado en `.claude/skills/shadcn-conventions/SKILL.md`,
secciones "Fila clicable → vista → editar" y "Catálogos maestros"; si cambias
