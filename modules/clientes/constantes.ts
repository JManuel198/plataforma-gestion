 ...
 * en la tabla compartida `correlativo`, y mismo separador `.`. Lo propio es
 * que usa 4 dígitos (como `PRS.0001` de Tarifario de personal).
 *
 * Hasta el 2026-09-25 el separador era `-` (`CLT-0001`), el único ámbito que
 * no usaba punto. Era una inconsistencia, no una convención: se corrigió y
 * ya no existe una constante de separador (ver la nota en la ficha de
 * Empresas de docs/spec/entidades.md).
 *
