...
acciones y consultas del backend (Partes 5 y 6), el modal de alta (Parte 7),
el kanban de solo lectura (Parte 8) y el detalle con sus acciones (Partes 9 y
10); el arrastre y la Tabla llegan después.
